...
<body>
    ...
    <dialog id="dialog-agregar">     
        <form method="POST" action="{{ route('productos.store') }}">
            ...
            <div class="modal-agregar">
                ...
                <input type="number" id="precio" name="precio" required class=modal-agregar-caja required>
            </div>
    ...
    <dialog id="dialog-editar">
        <form method="POST" id="form-editar">
            ...
            <div class="modal-agregar">
                <label for="precio">{{ __('Precio: ')}}</label>
                <input type="number" id="edit-precio" name="precio" required class=modal-agregar-caja required>
            </div>
    ...
    <dialog id="dialog-eliminar">
        ...
        <div class="modal-botones-div">
                <button id="btn-confirmar-eliminar" class="modal-botones">{{ __('Si')}}</button>
